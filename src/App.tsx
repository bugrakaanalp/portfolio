...
// Sayfa değişince en üste kaydırma
            ...
            <Container>
              <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <div className="flex gap-6 text-[var(--text-dim)]">
                   <a href="https://linkedin.com/in/bugrakaanalp1" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--text-main)] hover:scale-110 transition-all"><Linkedin size={18} strokeWidth={1.5} /></a>
